...
namespace SyncAdmission
{
    ...
    {
        static List<StudentDetail> studentItem = new List<StudentDetail>();
        static List<DepartmentDetail> departmentItem = new List<DepartmentDetail>();
        static List<AdmissionDetail> admissionItem = new List<AdmissionDetail>();
        static StudentDetail currentLoginStudent;
