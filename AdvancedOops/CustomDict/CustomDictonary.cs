...
{
    public class CustomDictonary<Tkey, Tvalue> : IEnumerable, IEnumerator
    {
        private int _count;
        ...
        public CustomDictonary()
        {
            _count = 0;
            _capacity = 4;
            _array = new KeyValue<Tkey, Tvalue>[_capacity];
        }
        public CustomDictonary(int size)
        {
            _count = 0;
            _capacity = size;
            _array = new KeyValue<Tkey, Tvalue>[_capacity];
        ...
        //Search the key value it is already here Remove the duplicate key otherwise enter the unique key:
